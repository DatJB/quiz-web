    ...
    data.forEach(student => {
        const row = `
            <tr class="border-b hover:bg-gray-50">
                <td class="py-3 px-4 text-sm font-small">${student.studentCode
        || ""}</td>
                <td class="py-3 px-4">
                ...
                <td class="py-3 px-4 text-sm">${student.studentClass
        || "D20CQCN05-B"}</td>
                <td class="py-3 px-4">
                ...
                <td class="py-3 px-4 text-gray-600 text-sm">${formatDate(
            student.createdAt)}</td>
                <td class="py-3 px-4">
